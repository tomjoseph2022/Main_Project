					...
					<form class="contact100-form validate-form">
                      ...
                      <div class="wrap-input100 rs1 validate-input">
                       ...
                       <br>
					    ...
					    <a href="index.php"><br>
					   <input type="button" name="edit" value="Back" class="contact100-form-btn" style="margin-left:-50px"></a>
					    
					   <a href="dayplan.php?package_id=<?php echo $data['package_id'];?>"><br>
					   	<input type="button"name="edit" style="margin-left:45px" value="Day Plan" class="contact100-form-btn"></a><br>
					   <a href="booking.php?package_id=<?php echo $data['package_id'];?>"><br>
					   <input type="button"name="edit" value="Book Now"  style="margin-left:300px" class="contact100-form-btn"></a>
					   <a href="packagecustomizepage.php?pid=<?php echo $data['package_id'] ?>">
					    <input type="button"name="edit" value="Customise Package" style="margin-left:110px;margin-top: -45px;" class="contact100-form-btn"></a>
