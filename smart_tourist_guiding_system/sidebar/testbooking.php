						  ...
						  <form action="#" name="myForm"  method="POST" onsubmit = "return(validate());"  enctype="multipart/form-data">
							<div class="user-details1">
							  ...
							  <div class="input-box1">
								...
								<input type="text" name="persons"  placeholder="Enter Number of Persons">	
							  </div>
							  <div class="input-box1">
  ...
  // number of days
 	 $date= ($end_date - $start_date)/60/60/24;
  	 ...
  	 ?>
							...
							<div class="input-box1">
								<span class="details1">Number of Persons</span><center>
								<input type="text" name="persons" value="<?php echo $date ?>" ></center>
							  </div>
  	 ...
  	 if($date==$duration){
  	 	...
  	 	echo "<script>alert('The selected dates between $duration days length')</script>";
