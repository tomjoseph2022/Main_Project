...
/*		padding-bottom: 25px;*/
	...
	<body>
		...
		<div class="wrapper">
			...
			<div class="main-container" style="background-color:#8AAAE5;
			">
				<div class="card">
					<?php
					$uname=$_SESSION['login_id'] ;
...
$sql= "SELECT * FROM tbl_package where package_type='Single_Tour' and package_status in ('0')";	
      ...
      $imageURL='package/'.$row["package_image"];
    	...
    	<div class="card2" >
			...
			<div class="cardall">
				...
				<div class="cardbtn">
					<div class="cardbtn1">
						<a href="singlebooking.php?package_id=<?php echo $row['package_id'];?>">
						<input type="submit" value="Book Now" ></a>
						
					</div>
					<div class="cardbtn2">

						<a href="singletourpackagedetails.php?package_id=<?php echo $row['package_id'];?>">
