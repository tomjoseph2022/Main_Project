...
try {
   ...
   // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
    ...
    $mail->Subject = 'Your Cab Booked by a Tourist....!';
    $mail->Body    = 'Your Cab Booked by a touirst from our Website.Thank you for your Choice !. For more Details Please <b>Login in Our Website</b> and <b>Have A Nice Day!!!</b>.';
