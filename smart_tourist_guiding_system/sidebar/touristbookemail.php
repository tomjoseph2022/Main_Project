...
try {
   ...
   // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
    ...
    $mail->Subject = 'Your Travel Package Booking Successfull....!';
    $mail->Body    = 'Your Travel Package Successfully Booked from our Website.Thank you for your Choice !. For more Details Please <b>Login in Our Website</b> and <b>Have A Nice Day!!!</b>.';
