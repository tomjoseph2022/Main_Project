   ...
   <meta charset="utf-8">
    ...
    <script type = "text/javascript">
      ...
      function validate() {
        ...
        var brak=document.myForm.breakfasts.value;
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="login-bg">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text" name="breakfasts" />
                                                <i class="fa fa-user login-user" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-button-pro">
                                                <a href="dayplan3.php?pid=<?php echo $ids ?> "> 
...

   {
      ...
      if(empty($adact1)){
       ...
       if(empty($adact2)){
        ...
        $sql = "INSERT INTO tbl_dayplan2(hotel,breakfast,activity1,launch,activity2,addactivity1,addactivity2,dinner,package_id) VALUES ('$arr','$hot','$act1','$lan','$act2','$adact1','$adact2','$din','$ids')"; 
