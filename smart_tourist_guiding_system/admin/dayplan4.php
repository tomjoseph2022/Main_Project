...

   {
      ...
      if(empty($adact1)){
       ...
       if(empty($adact2)){
        ...
        $sql = "INSERT INTO tbl_dayplan4(hotel,breakfast,activity1,launch,activity2,addactivity1,addactivity2,dinner,package_id) VALUES ('$arr','$hot','$act1','$lan','$act2','$adact1','$adact2','$din','$ids')"; 
