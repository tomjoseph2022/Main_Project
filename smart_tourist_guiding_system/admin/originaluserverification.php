                                                ...
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form action="#">
                                                        <div class="form-group-inner">
                                                            <a href="viewproof.php?login_id=<?php echo $data['login_id'];?>" style="margin-left: 50px;font-size: 20px;">view proof</a>
                                                                    <div class="col-lg-8">
                                                                    <div class="p-5">
                                                                  ...
                                                                  <!--  <div class="form-group row">
                                                                   ...
                                                                   <!--  <h4>Proof Type : <?php echo $row['proof_type'] ?></h4>
                                                                    <img src="<?php echo $imageURLL; ?>" style="margin-left: -10px" width="25%";> -->
                                                                     ...
                                                                     <br>
                                                                    <br><a href="databasefun.php?login_id=<?php echo $data['login_id']?>&eml=<?php echo $data['emails']; ?>"class="btn btn-primary btn-user btn-block">Accept</a>
                                                                    <a href="databasefun.php?login_rdid=<?php echo $data['login_id'];?>&eml=<?php echo $data['emails']; ?> "class="btn btn-primary btn-user btn-block">Reject</a>
                                                                    </form>
