                                ...
                                <div class="login-bg">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <?php
                                             $sqll="SELECT MAX(Package_id) as id from tbl_package";
                                             ...
                                             ?>
                                            <div class="login-button-pro">
                                                <!--  &nbsp &nbsp &nbsp &nbsp<a href="dayplan.php?pid=<?php echo $row['id'] ?> "> 
                                                        <input type="button" name="da" value="Enter DAYPLAN" class="login-button login-button-lg" style="margin-left:-50px"></a>&nbsp &nbsp -->
                                                <button type="submit" class="login-button login-button-lg" name="click">Create Package</button>&nbsp &nbsp
...

   {
      ...
      $req ="insert into tbl_package(package_name,package_type,package_season,package_features,package_location,package_duration,package_price,package_details,package_image) values ('$pname','$ptype','$pseason','$pfeature','$plocation','$pduration','$pprice','$pdetails','$filename')";
       ...
       echo "<script>alert('Package is created')</script>";
        ...
        $usern=$row['id'];
        header('location:dayplan.php?pid='.$usern);

        ob_end_flush();   
        //echo "$usern";
        ?>
        <!-- <center><input type="text" style="width:200px" value="<?php echo $usern ?>"></center> -->
