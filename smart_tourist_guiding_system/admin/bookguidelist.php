                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>List of  <span class="table-project-n">Guides Booked</span>  By Tourists</h1>
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true"  data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="id">TOURIST NAME</th>
                                                     <th data-field="name">BOOKED GUIDE ID</th> 
                                                    <th data-field="email">TOURIST EMAIL</th>
                                                    <!-- <th data-field="phone">GUIDE EMAIL</th> -->
                                                    <th data-field="company">BOOKED DATE STARTS</th>
                                                    <th data-field="complete">BOOKED DATE END</th>
                                                    <th data-field="task" >BOOKED TIME</th>
                                            ...
                                            $b=1;
                                            $c=2;
                                            $query12="SELECT tbl_guide_booking.*,tbl_registration.* from tbl_guide_booking,tbl_registration WHERE tbl_guide_booking.login_id=tbl_registration.login_id;";
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                  ...
                                                  <td><?php echo $data['firstname'].''.$data['lastname'];?></td>
                                                   ...
                                                   <td><a href="guideverification.php?login_id=<?php echo $data['guide_id']  ?>"><u><?php echo $data['guide_id'];?></u></a></td> 
