                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Driver Lists</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Driver <span class="table-project-n">Data</span> Lists</h1>
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true"  data-toolbar="#toolbar">
                                            ...
                                            $c=2;
                                            $rol="driver";
                                            $query="select tbl_login.*,tbl_registration.* from tbl_login,tbl_registration where tbl_login.login_id=tbl_registration.login_id and tbl_login.role='$rol'";                                    
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    <div class="button-ap-list responsive-btn">
                                                       ...
                                                       <a href="driververification.php?login_id=<?php echo $data['login_id'];?>"> 
