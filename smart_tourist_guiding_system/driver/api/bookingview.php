...
$query=mysqli_query($con,"SELECT tbl_cab_booking.*,tbl_registration.* from tbl_cab_booking,tbl_registration where tbl_cab_booking.login_id=tbl_registration.login_id and tbl_cab_booking.status = 0 and tbl_cab_booking.driver_id='$userid'" );
