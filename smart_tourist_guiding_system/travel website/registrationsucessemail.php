...
try {
   ...
   // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
    ...
    $mail->Subject = 'Your Touist Account registration Succesfull....!';
    $mail->Body    = 'Your tourist account has been Successfully created.Thank you for Choosing US !. For more Details Please <b>Login in to Our Website</b> and <b>Have A Nice Day!!!</b>.';
