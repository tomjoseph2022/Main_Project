	...
	<div class="main">
		<form name = "myForm" action="registration.php" onsubmit = "return(validate());" method="POST"  enctype="multipart/form-data">
			...
			<div id="name">
				...
				<input class="username" type="text" name="username" onblur="return(taskusers());"><span id="erroruser" style="margin-left:-80px"></span><br>
				<label class="passwordddlabel">Password :</label>
      ...
      mysqli_query($con,$req);
			...
			$usern=$row['login_id'];
      		...
      		mysqli_query($con,$sql); 
       		...
       		header("location:registrationsucessemail.php?eml=$eml");
