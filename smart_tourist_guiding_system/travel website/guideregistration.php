	...
	<script type = "text/javascript">
      ...
      function validate() {
        ...
        if(user=='')
         ...
         {
             errorpass.innerHTML = "<span style='color:red;'>"+
						"7 to 15 characters which contain at least one numeric digit and a special character  are required in Password filed</span>"
            return false;
         }
         ...
         if(addre=='')
         {
            ...
            return false;
         	...
         	alert("Your Registration successfully Submitted");
         }
...
<body> 
	...
	<div class="regform"><a href="index.php"><img src="images/2.png" style="margin-bottom: -49px;border-radius: 50% ;margin-left: -570px;"  
          class="img-circle"  width="40"; ></a><h1>Guide Registration Form</h1></div>
	<div class="main">
		<form name = "myForm" action="guideregistration.php" onsubmit = "return(validate());" method="POST"  enctype="multipart/form-data">
			<div id="name">
			...
			<input class="email"  type="email" name="emails" onblur="return(taskemail());"><span id="erroremail" style="margin-left:-300px"></span>
			...
			<div id="name">
				...
				</select><span id="errorstate"></span><br> 
				<label class="picodelabel">Pincode :</label>
				<input class="pincodenewpostion1" type="text" name="pincode" placeholder="Pincode..." onblur="return(taskpin());"><span id="errorpin" style="margin-left:180px"></span>
			</div>
			<div id="name">
				<h2 class="name">Dob</h2>
				<input class="dob" type="date" name="dobs" onblur="getAge()"><br>
				<label class="phonelabel">Moblie :</label>
				<input class="phonenewpostion" type="text" name="phone" placeholder="Mobile..." onblur="return(taskphone());"><span id="errorphone" style="margin-left:210px"></span>
			</div>
			<div id="name">
				<h2 class="name">Username</h2>
				<input class="username" type="text" name="username" onblur="return(taskusers());" placeholder="username"><span id="erroruser" style="margin-left:-80px"></span><br>
				<label class="phonelabel">Password :</label>
				<input class="password" type="password" name="pass" placeholder="Enter password" onblur="return(taskpass());">
			</div>
			<span id="errorpass" style="margin-left:500px;"></span>
			<h2 class="name">Con.Pass</h2>
			<input class="conpassword" type="password" name="conpassword" placeholder="confirm password" onblur="return(taskconpass());"><span id="errorpassword" style="margin-left:-300px"></span>
			...
			</label><label class="addresslabel">Address :</label>
			<span id="errorgen" style="margin-left:250px"></span>
			
			<input type="text" name="addresses" class="texte"  onblur="return(taskadd());" placeholder="Enter your Address">
     ...
     if($num == 0) {
      ...
      mysqli_query($con,$req);
			...
			$usern=$row['login_id'];
      		...
      		//$sql = "INSERT INTO tbl_guide_registration(firstname,lastname,address,emails,state,pincode,dobs,phone,gender,login_id) VALUES ('$fname',' $lname','$add','$eml','$statt','$pincodes','$dob','$phone','$gend','$usern')"; 
      		...
      		mysqli_query($con,$sql); 
       		...
       		header("location:guideregistrationsuccess.php?eml=$eml");
